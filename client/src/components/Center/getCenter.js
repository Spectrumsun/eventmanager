...
const getCenter = props => (
  <div onClick={props.clicked} className="card d-lg-inline-block" style={{ width: '18rem' }}>
    <img className="card-img-top" src={props.image} style={{ objectFit: 'cover', height: '15rem' }} alt="Card image cap" />
